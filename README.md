...
### Installation
I Create the project with `npm create vite@latest` and into in the project using `cd react_input ` and below have the link of the things that I used in this project or that you can use:
...
## Referência
- [Youtube] - React Router: O guia completo para navegação em aplicativos React | Matheus Battisti - Hora de Codar - (https://www.youtube.com/watch?v=7b42lVMdEjE&list=PLnDvRpP8BneyVA0SZ2okm-QBojomniQVO&index=50)